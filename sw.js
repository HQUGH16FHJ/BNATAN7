const CACHE_NAME = 'bantan-static-v4.0.21-center-theme-v2';
const CORE_ASSETS = [
  '/',
  '/landing.html',
  '/index.html',
  ...
  '/copyright/api.html',
  '/copyright/ops.html',
  '/copyright/rights-platform-v1.css',
  '/copyright/rights-platform.js',
  '/copyright/rights-archive-v1.css',
  '/copyright/rights-archive-v1.js',
  '/copyright/rights-archive-background.svg',
  '/copyright/world-map-v1.svg',
  '/sbom.json',
  '/checksums.json',
  '/explore.html',
  '/trust.html',
