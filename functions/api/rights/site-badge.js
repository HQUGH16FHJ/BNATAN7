...
export async function onRequestGet(context) {
  ...
  const accent = verified ? '#34d399' : '#f59e0b';
  ...
  <rect x="1" y="1" width="318" height="70" rx="16" fill="#0c0a08" stroke="${accent}" stroke-opacity=".42"/>
  ...
  <text x="72" y="28" fill="#fff7ed" font-family="Arial, sans-serif" font-size="13" font-weight="700">绊谈官方认证</text>
  <text x="72" y="46" fill="#d6c7b8" font-family="Consolas, monospace" font-size="10">${codeText}</text>
